...
export default class CoveyTownsStore {
   ...
   */
  createTown(friendlyName: string, isPubliclyListed: boolean, npcs: NPC[]): CoveyTownController {
    const newTown = new CoveyTownController(friendlyName, isPubliclyListed, npcs);
