...
import NPC, {ResponseNPC, ServerNPC} from "./NPC";
...
/**
 * Payload sent by the client to update an NPC
 */
...
export default class TownsServiceClient {
  ...
  async updateNPC(requestData: NPCUpdateRequest): Promise<void> {
    const responseWrapper = await this._axios.patch(`/towns/${requestData.coveyTownID}/npc`, requestData);
    return TownsServiceClient.unwrapOrThrowError(responseWrapper);
  }
}
